...
#define BIND_EVENT_2(Func) \
  std::bind(&Func, this, std::placeholders::_1, std::placeholders::_2);
#define BIND_EVENT_3(Func) \
  std::bind(&Func, this, std::placeholders::_1, std::placeholders::_2, \
            std::placeholders::_3);
#define BIND_EVENT_4(Func) \
  std::bind(&Func, this, std::placeholders::_1, std::placeholders::_2, \
...
class TEventDispatcher {
 ...
 public:
  ...
  void operator+=(FEvent func) { m_eventListeners.push_back(func); }

  void operator-=(FEvent func) { m_eventListeners.remove(func); }
